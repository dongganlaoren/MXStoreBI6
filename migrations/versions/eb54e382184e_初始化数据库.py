...
Revision ID: eb54e382184e
Revises: 
Create Date: 2025-06-24 11:46:56.825937
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=False, comment='关联的用户ID (唯一)'),
    sa.Column('store_id', sa.String(length=32), nullable=False, comment='关联店铺ID'),
    sa.Column('bank_account_name', sa.String(length=100), nullable=True, comment='银行账户名'),
    sa.Column('bank_account_number', sa.String(length=100), nullable=True, comment='银行账号'),
    sa.Column('is_primary_contact', sa.Boolean(), nullable=True, comment='是否为主要联系人'),
