...
# 不再导入 StoreStaff
from app.models import AttachmentType, DailySalesAttachments, RoleType, Store, User
    ...
    try:
        ...
        with db.session.begin_nested():
            ...
            for store in stores:
                ...
                emp_seq_mgr = str(
                    store_employee_counter[store.store_id]
                ).zfill(3)
