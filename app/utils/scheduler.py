...
def start_monitoring_tasks(app):
    ...
    # 每5分钟执行健康检查
    scheduler.add_job(
        func=lambda: run_health_checks_job(app),
    ...
    # 每小时清理旧数据
    scheduler.add_job(
        func=lambda: cleanup_old_data_job(app),
