lang_dict = {
    'zh': {
        ...
        'id_card_number': '身份证号',
        'id_card_copy': '身份证复印件',
        'id_card_copy_placeholder': '请上传身份证复印件',
        'id_card_copy_tip': '仅支持图片或PDF格式，最大10MB',
        'register_time': '注册时间',
        'work_info': '工作信息',
        'start_date': '入职日期',
        'end_date': '离职日期',
        ...
        'reimbursement_approval_time': '审批时间',
        'reimbursement_approval_attachment': '审批相关附件',
        'reimbursement_action': '操作',
        'reimbursement_detail_btn': '详情',
        'reimbursement_approve_btn': '审批',
        'reimbursement_create_btn': '发起申请',
        'reimbursement_filter': '筛选',
        ...
        'reimbursement_approved': '审批通过',
        'reimbursement_rejected': '已拒绝',
        'reimbursement_attachment_submission': '报销附件',
        'reimbursement_attachment_approval': '审批附件',
        'reimbursement_time': '时间',
        'reimbursement_custom_date': '自定义',
        'reimbursement_recent_24h': '最近24小时',
        'reimbursement_recent_7d': '最近7天',
        'reimbursement_recent_30d': '最近30天',
        'reimbursement_start_date': '开始日期',
        'reimbursement_end_date': '结束日期',
        ...
        'approval_related_attachments': '审批相关附件',
        'can_upload_multiple_files': '可上传多个附件，支持直接粘贴截图',
        'approve_pass': '审批通过',
        'return': '返回',
        'reimbursement_attachments_related': '报销相关附件',
        ...
        'edit': '编辑',
        'delete': '删除',
        'confirm_withdraw': '确定要撤回该申请吗？撤回后可在草稿箱编辑。',
        'SHARED_COST': '公摊',
        ...
        'reimbursement_approval_comments': '审批意见',
        'reimbursement_approval_attachments': '审批附件',
        'reimbursement_id': 'ID',
        'reimbursement_applicant_info': '申请信息',
        'reject': '拒绝',
        ...
        'confirm_withdraw_msg': '确定要撤回该申请吗？撤回后可在草稿箱编辑。',
        'confirm_delete_draft_msg': '确定要删除该草稿吗？删除后无法恢复。',
        'reimbursement_cc_recipients': '抄送人',
        'reimbursement_related_attachments': '相关附件',
        'reimbursement_upload_attachments_tips': '可上传多个附件，支持直接粘贴截图',
        'reimbursement_approval_pass': '审批通过',
        'reimbursement_return': '返回',
        'reimbursement_attachment_preview': '附件预览',
        'preview': '预览',
        'default_cc_recipient_badge': '默认抄送人',
        'manual_added_cc_badge': '手动添加的抄送人',
        ...
        'operation': '操作',
        'disable': '禁用',
        'confirm_disable_default_cc': '确定要禁用该默认抄送人吗？',
        'no_default_cc_config': '暂无默认抄送人配置',
        'download_view': '点击下载/查看',
    ...
    'th': {
        ...
        'filter': 'กรอง',  # Filter
        'approved': 'ตรวจสอบแล้ว',  # Approved
        'pending': 'รอตรวจสอบ',  # Pending
        'all_status': 'ทั้งหมด',  # All
        'all_stores': 'ทุกสาขา',  # All stores
        'finance_remark': 'หมายเหตุการเงิน',  # Finance remark
        'finance_remark_placeholder': 'กรุณากรอกหมายเหตุการเงิน',  # Please enter finance remark
        'no_remark': 'ไม่มีหมายเหตุ',  # No remark
        'key_change_history': 'ประวัติการแก้ไขฟิลด์สำคัญ',  # Key field change history
        'field': 'ฟิลด์',  # Field
        'old_value': 'ค่าเดิม',  # Old value
        'new_value': 'ค่าใหม่',  # New value
        'operator': 'ผู้ดำเนินการ',  # Operator
        'reason': 'เหตุผล',  # Reason
        'time': 'เวลา',  # Time
        'no_key_change_history': 'ไม่มีประวัติการแก้ไขฟิลด์สำคัญ',  # No key field change history
        'daily_voucher': 'ใบเสร็จประจำวัน',  # Daily voucher
        'voucher_img': 'รูปภาพใบเสร็จ',  # Voucher image
        'pdf_preview': 'ดูตัวอย่าง PDF',  # PDF preview
        'file': 'ไฟล์',  # File
        'no_voucher': 'ไม่มีใบเสร็จ',  # No voucher
        'prev_page': 'หน้าก่อนหน้า',  # Previous page
        'next_page': 'หน้าถัดไป',  # Next page
        'page_info': 'หน้า',  # Page
        'page': 'หน้า',  # Page
        ...
        'create_daily_report': 'สร้างรายงานประจำวันใหม่',  # Create new daily report
        'bank_deposit': 'ยอดเงินฝากธนาคาร (BC)',  # Bank deposit amount (BC)
        'bank_fee': 'ค่าธรรมเนียมการฝาก (BF)',  # Bank fee (BF)
        'start_check': 'เริ่มตรวจสอบ',  # Start check
