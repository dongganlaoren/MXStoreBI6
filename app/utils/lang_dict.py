lang_dict = {
    ...
    'th': {
        ...
        'user_detail_subtitle': 'ข้อมูล��ายละเอียดผู้ใช้',
        'active': 'ใช้งาน',
        'inactive': 'ปิดใช้งา��',
        ...
        'reimbursement_submitter': 'ผู้ขอ',
        'reimbursement_approver': 'ผู้อนุมัติ',
        'reimbursement_submission_date': 'วันที่ขอ',
        'reimbursement_reason': 'เหตุผลการเบิกจ่าย',
        'reimbursement_attachments': 'ไฟล์แนบที่เกี่ยวข้อง',
        'reimbursement_approval_comments': 'ความคิดเห็นการอนุมัติ',
        'reimbursement_approval_time': 'เวลาการอนุมัติ',
        'reimbursement_approval_attachment': 'ไฟล์แนบการอนุมัติ',
        ...
        'reimbursement_search_approver': 'ค้นหาผู้อนุมัติด้วยชื่อ/รหัส/เบอร์โทร',
        'reimbursement_attachment_tip': 'สามารถอัปโหลดหลายไฟล์ รองรับวางภาพหน้าจอ',
        ...
        'reimbursement_attachment_submission': 'ไฟล์แนบคำขอ',
        'reimbursement_attachment_approval': 'ไฟล์แนบการอนุมัติ',
        'reimbursement_time': 'เวลา',
        'reimbursement_custom_date': 'กำหนดเอง',
