lang_dict = {
    ...
    'th': {
        ...
        'btn_submit_commit': 'ยืนยันส่ง',
        'btn_reset_ui': 'รีเซ็ต',
        'btn_clear_draft': 'ล้างข้อมูล',
        'table_col_category': 'หมวดหมู่',
        'table_col_code': 'รหัสสินค้า',
        'table_col_name': 'ชื่อสินค้า (จีน/ไทย)',
        'table_col_spec': 'สเปค',
        'table_col_case': 'ยกลัง',
        'table_col_group': 'เศษ',
        'table_col_valid_until': 'วันหมดอายุ',
        'label_store': 'ร้านค้า',
        'label_check_date': 'วันที่ตรวจนับ',
        'label_start_date': 'วันที่เริ่มต้น',
        'label_end_date': 'วันที่สิ้นสุด',
        'btn_query': 'ค้นหา',
        'msg_draft_saved': 'บันทึกร่างสำเร็จ',
        'msg_committed': 'ส่งข้อมูลสำเร็จ',
        'msg_loading': 'กำลังโหลด...',
        'placeholder_search': 'ค้นหา: รหัส/ชื่อ/หมวดหมู่',
        'modal_title_edit_material': 'แก้ไขข้อมูลสินค้า',
        'label_material_image': 'รูปสินค้า',
        'label_per_group_qty': 'จำนวนต่อกลุ่ม',
        'label_price_per_case': 'ราคายกลัง (บาท)',
        'label_price_per_group': 'ราคาต่อหน่วย (บาท)',
        'label_safety_stock': 'สต็อกขั้นต่ำ',
        'label_status': 'สถานะ',
        ...
        'btn_cancel': 'ยกเลิก',
        'tip_mobile_view': 'เคล็ดลับ: คลิก "บันทึกร่าง" เพื่อบันทึกข้อมูล',
        'text_no_data': 'ไม่มีข้อมูล',
        'text_all_stores': 'ร้านค้าทั้งหมด',
        'text_stocktake_intro': 'หน้านี้ใช้สำหรับการป้อนข้อมูลการตรวจนับสต็อก รองรับการ <strong>บันทึกร่าง</strong> และ <strong>ยืนยันส่ง</strong><br>การบันทึกร่างสามารถทำซ้ำได้ (เขียนทับ) เมื่อยืนยันส่งแล้ว ข้อมูลของวันนั้นจะถูกล็อค (ต้องให้ผู้ดูแลระบบรีเซ็ตจึงจะแก้ไขได้)',
        'text_store_bound_tip': 'ผูกกับร้านค้าของบัญชีที่ล็อกอินอยู่',
        'label_tip': 'คำแนะนำ',
        'text_auto_load_tip': 'เปลี่ยนร้านค้า/วันที่ เพื่อโหลดข้อมูลอัตโนมัติ',
        'text_stocktake_note': 'หมายเหตุ: หน้านี้ยกเลิกการค้นหาและการบันทึกทีละรายการ<br>คุณสามารถป้อนจำนวนและวันหมดอายุทีละรายการ แล้วคลิก "บันทึกร่าง" เพื่อบันทึกทั้งหมด; เมื่อตรวจสอบแล้วคลิก "ยืนยันส่ง"',
        'text_unsaved_changes': 'การเปลี่ยนแปลงที่รอการบันทึก',
        'text_highlight_tip': 'คำแนะนำ: แถวที่มีการแก้ไขจะไฮไลท์; คลิก "บันทึกร่าง" เพื่อบันทึกแถวที่ไฮไลท์ทั้งหมด',
        'title_stocktake_records': 'ประวัติการตรวจนับ',
        'text_records_intro': 'ค้นหาข้อมูลการตรวจนับของแต่ละร้านค้า และคำนวณมูลค่าสต็อก (บาท)',
        'col_store': 'ร้านค้า',
        'col_submit_time': 'เวลาที่ส่ง',
        'col_stock_value': 'มูลค่าสต็อก (THB)',
        'col_detail': 'รายละเอียด',
        'label_summary_total': 'มูลค่ารวมทั้งหมด:',
        'btn_view_detail': 'ดูรายละเอียด',
        'text_download_template_intro': 'คุณสามารถเพิ่ม/อัปเดตข้อมูลสินค้าเป็นชุดผ่าน <strong>การนำเข้า Excel template</strong> หรือจัดการข้อมูลพื้นฐานของสินค้าที่มีอยู่ได้ในตารางด้านล่าง<br>ชื่อแผ่นงานใน Template ต้องเป็น: <code>Product Info</code> และส่วนหัวตารางต้องตรงกันทุกประการ',
        'title_import_excel': 'นำเข้า Excel Template',
        'text_template_tip': 'รองรับเฉพาะ Template มาตรฐาน inventory_stocktake_template.xlsx (Worksheet: Product Info)',
        'btn_upload_import': 'อัปโหลดและนำเข้า',
        'title_import_result': 'ผลการนำเข้า',
        'text_success_count': 'สำเร็จ',
        'text_fail_count': 'ล้มเหลว',
        'col_row_number': 'แถวที่',
        'col_result': 'ผลลัพธ์',
        'col_success': 'สำเร็จ',
        'col_fail': 'ล้มเหลว',
        'col_description': 'คำอธิบาย',
        'title_existing_products': 'ข้อมูลสินค้าที่มีอยู่ (แสดงสูงสุด 300 รายการ)',
        'text_no_image': 'ไม่มีรูป',
        'text_draft_conflict': 'การสลับร้านค้า/วันที่ อาจทำให้ข้อมูลที่ยังไม่บันทึกสูญหาย',
        'text_commit_lock_tip': 'หลังจากยืนยันส่ง ข้อมูลการตรวจนับของวันนี้จะถูกล็อค',
