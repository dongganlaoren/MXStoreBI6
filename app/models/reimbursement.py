...
from app.models.enums import ReimbursementStatus, ReimbursementAttachmentType, ReimbursementPrimaryCategory, ReimbursementSecondaryCategory
...
class ReimbursementAttachment(db.Model):
    ...
    request_id = db.Column(db.Integer, db.ForeignKey('reimbursement_requests.request_id'), nullable=False, comment="所属报销申请ID")
